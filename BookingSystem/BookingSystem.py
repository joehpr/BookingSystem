...
text = Text(windowL, text="Genom att boka flyg med Norwegian accepterar du våra villkor som finns tillgängliga på www.norwegian.com/termsandconditions. Du accepterar också vår användning av cookies.", size=14)
...
text = Text(windowS, text="Genom att boka flyg med Norwegian accepterar du våra villkor som finns tillgängliga på www.norwegian.com/termsandconditions. Du accepterar också vår användning av cookies.", size=14)
